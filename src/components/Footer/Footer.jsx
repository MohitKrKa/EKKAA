...
import talktoExpert from "../../assets/Footer/talktoExpert.svg";
import line from "../../assets/Footer/Line.svg";
import line1 from "../../assets/Footer/Line1.svg";
import logo from "../../assets/Footer/Logo.png";
import socialIcon from "../../assets/Footer/socialIcon.svg";
import socialIcon1 from "../../assets/Footer/socialIcon1.svg";
import emailIcon from "../../assets/Footer/emailIcon.png";
import callIcon from "../../assets/Footer/callIcon.png";
import locationIcon from "../../assets/Footer/locationIcon.png";
import emailButton from "../../assets/Footer/emailButton.svg";
    ...
    <div className="flex relative flex-col  h-auto  text-white bg-[#080E1C] max-md:px-10 max-md:py-0">
      ...
      <div className="flex flex-row justify-center">
        <div className="flex flex-col">
          ...
          <span className=" font-[Mulish] font-[300] text-base">
  ...
  const MobileFooter = () => (
    <div className="flex relative flex-col h-auto text-white bg-[#080E1C] px-6 py-8">
      ...
      <div className="flex flex-col items-center mt-6">
        ...
        <span className="font-[Mulish] font-[300] text-sm text-center mb-6">
